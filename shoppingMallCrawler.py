...
#숨겨진 위치로 접근 2개의 과정을 하나로 생략 가능한지?
...
# 페이지수 읽어오기 
page_num = source.find('div',{'class':'pagination pagination-interval'}).find('span',{'class':'num'}).get_text()
...
for i in range(1,page_num+1):
    ...
    revies_table = source.find('tbody') #print(revies_table)
