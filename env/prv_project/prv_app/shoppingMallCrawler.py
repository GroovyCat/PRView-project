...
def search_shop_review():
    ...
    # 텍스트파일에 댓글 저장하기
    file_a = open('shoppingMall_all_craw\shoppingMall_all.txt','w',encoding='utf-8')
    file_p = open('shoppingMall_pos_craw\shoppingMall_pos.txt','w',encoding='utf-8')
    file_n = open('shoppingMall_neg_craw\shoppingMall_neg.txt','w',encoding='utf-8')
